...
import type { WhiteBannerV1Block as WhiteBannerV1BlockType, BlockDefinition } from '@/types/blocks'
import type { BlockRenderProps, BlockEditorProps } from '../../types'
import { v4 as uuidv4 } from 'uuid'

const defaultProps = {
  title: 'Discover Something Amazing',
  subtitle: 'Join thousands who already love what we do',
  imageUrl: '',
  btnText: 'Learn More',
  btnUrl: '#',
...
export const whiteBannerV1Definition: BlockDefinition = {
  type: 'white-banner-v1',
  name: 'Banner V1',
  description: 'Full-width banner with image background, title and CTA button',
  icon: 'image',
  category: 'white',
  defaultProps: { ...defaultProps },
}

export const createWhiteBannerV1Block = (): WhiteBannerV1BlockType => ({
  id: uuidv4(),
  type: 'white-banner-v1',
  order: 0,
  props: { ...defaultProps },
...
export const WhiteBannerV1Block: FC<BlockRenderProps<WhiteBannerV1BlockType>> = ({ block, isSelected }) => {
  const { props } = block
  return (
    <div
...
export const WhiteBannerV1Editor: FC<BlockEditorProps<WhiteBannerV1BlockType>> = ({ block, onChange }) => {
  const { props } = block
  return (
