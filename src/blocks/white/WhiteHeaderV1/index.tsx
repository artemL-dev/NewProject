...
import type { WhiteHeaderV1Block as WhiteHeaderV1BlockType, BlockDefinition } from '@/types/blocks'
import type { BlockRenderProps, BlockEditorProps } from '../../types'
import { v4 as uuidv4 } from 'uuid'

export const whiteHeaderV1Definition: BlockDefinition<WhiteHeaderV1BlockType> = {
  type: 'white-header-v1',
  name: 'Header V1 - Classic',
  category: 'white',
  description: 'Simple horizontal header with logo, nav, and CTA button. Mobile hamburger menu.',
  factory: (): WhiteHeaderV1BlockType => ({
    id: uuidv4(),
    type: 'white-header-v1',
    props: {
      logoText: 'BrandName',
...
export const WhiteHeaderV1Render: FC<BlockRenderProps<WhiteHeaderV1BlockType>> = ({ block }) => {
...
export const WhiteHeaderV1Editor: FC<BlockEditorProps<WhiteHeaderV1BlockType>> = ({ block, onChange }) => {
